...
public class SellActivity extends AppCompatActivity {
    ...
    private EditText editTextModel, editTextPrice,ProdType, QuantityTxt,  DescTxt;
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            BrowseModel product = new BrowseModel(editTextModel.getText().toString().trim(),
                                    taskSnapshot.getUploadSessionUri().toString(),ProdType.getText().toString().trim(),
                                    Float.valueOf(editTextPrice.getText().toString()),DescTxt.getText().toString(),Integer.valueOf(QuantityTxt.getText().toString()));
